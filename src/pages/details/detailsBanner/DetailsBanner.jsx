                            ...
                            <div className="right">
                                ...
                                <div className="info">
                                    {data.status&&<div className="infoItem">
                                        ...
                                        <span className="text">{data.status}</span> </div>}

                                        {data.release_date&&<div className="infoItem">
                                        <span className="text Bold">Release Date:{" "}</span>
                                        <span className="text">{dayjs(data.release_date).format("MMM D, YYYY")}</span> </div>}
                                        {data.runtime&&<div className="infoItem">
                                        <span className="text Bold">Runtime :{" "}</span>
                                        <span className="text">{toHoursAndMinutes(data.runtime)}</span> </div>}
